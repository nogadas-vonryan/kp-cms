...
export const kp23: KPTemplate = {
  ...
  fields: [
    ...
    { key: 'complainant1', label: 'First Complainant Name', type: 'text', required: true, placeholder: 'Primary complainant from above' },
    { key: 'complainant2', label: 'Second Complainant Name (Optional)', type: 'text', required: false },
  ...
  generatePdf: (data): TDocumentDefinitions => {
    ...
    return {
      ...
      content: [
        ...
        {
          text: [
            'This is to certify that the above-captioned case was dismissed due to ',
            { text: data.complainant1 || '_____________', decoration: 'underline' },
            ' (name) and ',
            { text: data.complainant2 || '_____________', decoration: 'underline' },
            ' (name) willful failure or refusal to appear for hearing before the Punong Barangay/Pangkat ng Tagapagkasundo and therefore complainant/s is/are barred from filing an action in court/government office.\n\n',
